...
public class DataFlowJob 
{
    public static void main( String[] args ) 
    {
        ...
        // AGGREGATE
       Table aggregate = tableEnv.sqlQuery("SELECT SUM(quantity) as summedQ FROM products_on_hand;");
       aggregate.printSchema();

       // SINK
        tableEnv.executeSql("CREATE TABLE products_on_hand_output (\n" +
            "summedQ BIGINT\n" +
        ") WITH (\n" +
            "'connector' = 'kafka',\n" +
        ...
        aggregate.executeInsert("products_on_hand_output");
